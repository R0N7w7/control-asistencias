...
import { Calendar1Icon, ClockIcon, FileDownIcon, UserIcon, UsersIcon } from "lucide-react";
        ...
        <>
            <div className="flex flex-col sm:flex-row gap-2 w-full items-end justify-between">
                <div className="flex flex-col gap-1 w-full items-start">
                    ...
                    <p className="text-lg text-neutral-600 font-medium">
                        Gestiona y supervisa las horas de servicio social y prácticas profesionales
                    </p>
                </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 ">
                <CardInfo
                    ...
                    extra="Practicantes activos"
                />
                <CardInfo
                    titulo="Horas Validadas"
                    valor={`${horasSemana}`}
                    extra="Horas aprobadas"
                />
                <CardInfo
                    titulo="Horas Pendientes"
                    valor={`${horasMes}`}
                    extra="Horas a validar"
                />
                <CardInfo
                    titulo="Ausencias"
                    valor={`${horasPendientes}`}
                    extra="Dias sin registro"
                />
            </div>
